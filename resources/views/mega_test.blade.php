        ...
        <div class="row">
            ...
            <div class="col-2">
                <table class="table">
                    ...
                    <tbody>
                    @foreach($sumPatterns as $pattern => $value)
                        <tr>
                            <td>{{$pattern}}</td>
                            <td>{{$value}}</td>
                        </tr>
            ...
            {{--<div class="col-5">--}}
                {{--<table class="table">--}}
                    {{--<thead>--}}
                    {{--<tr>--}}
                        {{--<th colspan="3">Number pattern</th>--}}
                    {{--</tr>--}}
                    {{--<tr>--}}
                        {{--<th>Pattern</th>--}}
                        {{--<th>Value</th>--}}
                    ...
                    {{--@foreach($newNumbersPatterns as $pattern => $value)--}}
                        {{--<tr>--}}
                            {{--<td>{{$pattern}}</td>--}}
                            {{--<td>{{$numberPatterns[$pattern]}} ({{$value}})</td>--}}
                            {{--<td>--}}
            ...
            <div class="col-7">
                <table class="table">
                    <thead>
                    <tr>
                        <th colspan="4">Position pattern</th>
                    </tr>
                    <tr>
                        <th>Pattern</th>
                        <th>Expected</th>
                    ...
                    @foreach($newPositionPatterns as $pattern => $value)
                        <tr @if(!empty($expectedPossibilities[$pattern]) && $expectedPossibilities[$pattern] < $value)style="color: green" @else style="color:red;" @endif>
                            ...
                            <td>{{$expectedPossibilities[$pattern] ?? ''}}</td>
                            <td>{{$value}}</td>
